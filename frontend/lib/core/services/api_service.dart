...
/// Handles all communication with the auth backend.
class ApiService {
  ...
  /// Wraps authenticated HTTP requests. If it encounters a 401, it attempts
  /// to refresh the token and retry the original request once.
